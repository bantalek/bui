    ...
    return (
      <div>
        ...
        <div style={styles.componentFamilyContainer}>
          ...
          <div style={styles.componentContainer}>
            <Text type="condensed" condenseThreshold={1000}>Text condensed Component</Text>
            <br />
            <br />
            <Text type="span">
              {'Bech32 : '}
            ...
            <xmp style={styles.xmp}>{condensedCode0}</xmp>
            <br />
            <Text type="span">
              {'Bech32 : '}
              <Text type="condensed" copyIcon={true}>
                bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq
              </Text>
            </Text>
            <xmp style={styles.xmp}>{condensedCode1}</xmp>
            <br />
            <Text type="span">
              {'Bech32 : '}
              <Text type="condensed" copyIcon={true} prefix={2} suffix={4}>
                bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq
              </Text>
            </Text>
            <xmp style={styles.xmp}>{condensedCode2}</xmp>
          </div>
        </div>
        <div style={styles.componentFamilyContainer}>
